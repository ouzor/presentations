...
* deploy on ouzor.github.io with sources
* also PDF on slideshare?
...
More and more data science services will be used.
...
<article class="smaller">
* Factor analysis of election machine results by Yle, source: [Yle 13.4.2015](http://yle.fi/uutiset/kuka_on_oikeistolaisin_kuka_liberaalein__katso_miten_ehdokkaasi_asettuu_poliittiselle_nelikentalle/7919930)
</article>
...
Data-driven solutions for any business sector
...
<center>
<img src="http://www.marketingdistillery.com/wp-content/uploads/2014/11/mds_f.png" alt="skill set" style="height: 600px"/>
</center>
...
According to interviews and expert estimates, 50-80 % of data scientists' time is spent on handcrafted work (data "wrangling/munging").

<article class="smaller">
* Source: [New York Times 18.8.2014][nyt-ds80]
</article>
...
* Open data science (tools, data, analyses)
* Data science communities in Finland
* Beginner data scientist stuff
* Blogs and other interesting resources
...
## Extra: Beginner data scientist stuff

Start playing with open data!
